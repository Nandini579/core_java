...
public class App {
	public static void main(String[] args) {
		...
		System.out.println("2:Find Employees by FirstName" );
		System.out.println("3:Find Employees by FirstName and their PhoneNumber"); 
		System.out.println("4:Update PhoneNumber and Email ");
		System.out.println("5:Delete Details of Employee ");
		System.out.println("6:Find Employees by FirstName and Email with matching Date of Birth");
		System.out.println("7:Find Employees by FirstName and PhoneNumber with matching  Wedding Date");
		while(true) {
